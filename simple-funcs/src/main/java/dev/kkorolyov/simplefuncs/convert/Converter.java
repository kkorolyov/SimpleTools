...
public interface Converter<T, R> {
	...
	@SafeVarargs
	static <T, R> Converter<T, Optional<? extends R>> reducing(Converter<? super T, Optional<? extends R>> delegate, Converter<? super T, Optional<? extends R>>... delegates) {
	 ...
	 */
	static <T, R> Converter<T, Optional<? extends R>> reducing(Iterable<? extends Converter<? super T, Optional<? extends R>>> delegates) {
